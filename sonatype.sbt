...
pomExtra := (
  <url>http://www.github.com/rjmac/rojoma-json-jackson</url>
  <licenses>
  ...
  <scm>
    <url>git://github.com/rjmac/rojoma-json-jackson.git</url>
    <connection>scm:git://github.com/rjmac/rojoma-json-jackson.git</connection>
  </scm>
  <developers>
    <developer>
      <id>robertm</id>
